...
function App() {
  ...
  const handleSendMessage = async (messageText) => {
    ...
    if (messageText) {
      ...
      try {
        const response = await fetch(`https://m-abdu11ah-search-api.hf.space/search/chatbot?text='${encodeURIComponent(messageText)}'`, {
            method: "GET",
        });
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      {isOpen ? (
        <div className="bg-gray-900 border border-gray-700 rounded-lg shadow-lg w-[350px] lg:w-[500px] h-screen max-h-[80vh] min-h-[200px] flex flex-col">
...
//       try {
//         const response = await fetch(`http://localhost:49152/search/chatbot/?text=${encodeURIComponent(messageText)}`, {
//             method: "GET",
//         });
